...
try:
    from comfy.ldm.modules.diffusionmodules.model import vae_attention  # optional
except Exception:
    def vae_attention(*args, **kwargs):
        raise RuntimeError("Comfy VAE attention not available (optional dependency missing).")
